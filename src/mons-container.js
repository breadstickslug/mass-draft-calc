...
export function MonsContainer({ tabActive, collapsed, sideCode, imported, updateMons, gameType, setExportString }){
    ...
    */
    ...
    return (
        <partyContext.Provider value={{ notes, setMonNotes, setSpecie, setNature, setAbility, setItem, setTeraType, setTeraActive, setMoveset, setZs, setEVs, setIVs, setBoosts, setStatus, gameTypeMemo }}>
